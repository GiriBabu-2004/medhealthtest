...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Feedback Section */}
      {feedbacks.length > 0 && (
        <div className="w-full max-w-6xl bg-white border border-green-500 shadow-lg p-8 overflow-hidden mt-4 ">
              ...
              {[...feedbacks, ...feedbacks].map((f, i) => (
                ...
                >
                  <div className="flex items-center mb-2">
                    ...
                    {[...Array(5 - f.rating)].map((_, j) => (
                      <span key={j} className="text-gray-300 text-lg">
                        ★
                      </span>
                    ))}
                  </div>
